        ...
        <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/60 backdrop-blur-xl">
            <div className="container mx-auto px-4 h-20 flex items-center justify-between gap-4">
                ...
                <Link to="/" className="flex items-center gap-3 font-bold text-2xl tracking-tighter hover:opacity-90 transition-opacity">
                    ...
                    <span className="hidden sm:inline bg-gradient-to-r from-white to-sky-400 bg-clip-text text-transparent" data-testid="logo-text">
                        THE GREAT CATCH
                    </span>
                </Link>
                ...
                <div className="hidden md:flex flex-1 max-w-md relative group">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-sky-400 group-focus-within:text-white transition-colors" />
                    <input
                        type="text"
                ...
                <div className="flex items-center gap-4">
                    {user ? (
                        <div className="flex items-center gap-3">
                            {isAdmin && (
                                <Link to="/admin" className="text-sm font-black text-sky-400 hover:text-white tracking-widest uppercase" data-testid="nav-admin">
                                    Admin
                                </Link>
                            )}
                            <div className="flex flex-col items-end hidden sm:flex">
                                <span className="text-[10px] font-black text-sky-400 uppercase tracking-widest leading-none mb-1">Active User</span>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link to="/login" className="flex items-center gap-2 text-sm font-black text-sky-400 hover:text-white transition-colors tracking-widest uppercase" data-testid="nav-login">
                    ...
                    <Link to="/cart" className="p-2 hover:bg-white/5 rounded-full relative" data-testid="cart-btn" aria-label="Shopping Cart">
                    ...
                    <button className="md:hidden p-2 hover:bg-white/5 rounded-full" aria-label="Open menu">
